    ...
    >
      <div className="p-2 md:p-3">
        <button
          ...
          className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-white px-3 py-2.5 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 transition-all hover:bg-slate-50 hover:text-ocl-primary disabled:opacity-50 md:min-h-0 md:px-4"
        >
                ...
                return (
                  <li key={c.id}>
                    <button
                      ...
                      className={cn(
                        'group relative flex min-h-[44px] w-full flex-col items-start justify-center gap-1 rounded-lg px-2.5 py-2.5 transition-all md:min-h-0 md:px-3',
                        isSelected
                          ? 'bg-slate-200/50'
                      ...
                      {(onDelete || onRename) && (
                        <div className="absolute right-1 top-1/2 -translate-y-1/2">
                          <button
                            ...
                            aria-label="Opções"
                            className={cn(
                              'rounded p-1.5 text-slate-500 hover:text-slate-800',
