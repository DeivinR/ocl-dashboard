import { Briefcase, LogOut, ChevronRight, UploadCloud, TrendingUp, Sparkles, SendHorizontal, Bot } from 'lucide-react';
...
export const LandingPage = ({ onSectionSelect, onUpload, onLogout, onSendMessage, onOpenChat }: Readonly<LandingPageProps>) => {
