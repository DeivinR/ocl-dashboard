...
import { Briefcase, LogOut, ChevronRight, Settings, TrendingUp, Bot, Sparkles, SendHorizontal } from 'lucide-react';
      ...
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-8 py-4 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          {userDisplay.name && (
            <div className="hidden flex-col leading-tight md:flex">
              <div className="text-sm font-bold text-slate-900">{userDisplay.name}</div>
              <div className="text-xs text-slate-500">{userDisplay.role}</div>
            </div>
          )}
        </div>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center rounded-lg border border-slate-200 bg-white p-2.5 text-slate-700 transition-colors hover:bg-slate-100"
            title="Configurações"
          >
            <Settings size={20} />
          </button>
        ...
        <div className="w-full max-w-5xl">
          <div className="mb-12 text-center">
            <h1 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">
              Olá, {userDisplay.firstName || 'Bem-vindo'}!
            </h1>
